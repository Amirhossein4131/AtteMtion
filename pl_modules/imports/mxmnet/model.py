'''
https://github.com/zetayue/MXMNet/blob/master/model.py
S. Zhang, Y. Liu, L. Xie, Molecular Mechanics-Driven Graph Neural Network with Multiplex Graph for Molecular Structures,
arXiv:2011.07457, NeurIPS 2020
'''
...
from pl_modules.imports.mxmnet.layers import Global_MP, Local_MP
from pl_modules.imports.mxmnet.utils import BesselBasisLayer, SphericalBasisLayer, MLP


class Config(object):
    def __init__(self, dim, n_layer, cutoff, use_embeddings=True):
        self.dim = dim
